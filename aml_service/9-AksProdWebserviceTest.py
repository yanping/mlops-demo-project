...
try:
    ...
    with open("aml_config/aks_webservice2.json") as f:
    ...
    with open("aml_config/config.json") as f:
        config = json.load(f)
    resource_group = config["resource_group2"]
    aks_name = config["aks_name2"]
    aks_service_name = config["aks_service_name2"]
    aks_namespace = config["aks_namespace2"]
...
with open("aml_config/aks_webservice2.json", "w") as outfile:
